...
function LoginPage() {
    ...
    return (
        <div>
            ...
            <h1 className='text-center my-[30px] text-mainBlue font-bold sm:text-sm md:text-3xl'>Sign in with username: emilys and password: emilyspass to see all products.</h1>
            {/* start from here! */}
